...
urlpatterns = [
    ...
    path('logout/', auth_view.LogoutView.as_view(next_page='account/logout/'), name='logout'),
    path('register/', views.account_registration, name='register'),
    path('activate/<slug:uidb64>/<slug:token>/', views.account_activate, name='activate'),
    #Reset password
    path('password_reset/', auth_view.PasswordResetView.as_view(template_name='account/user/password_reset_form.html',
